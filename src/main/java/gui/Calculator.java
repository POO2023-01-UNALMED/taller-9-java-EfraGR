...
public class Calculator extends VBox implements EventHandler<ActionEvent>{
	...
	public void handle(ActionEvent event) {
		...
		String accti = ((Button) event.getSource()).getText();

		if(accti.equals("+")||accti.equals("-")||accti.equals("/")|| accti.equals("*")) {
		...
		else if	(accti.equals("=")) {
			
			float num11 = Float.parseFloat(number1);
			float num22 = Float.parseFloat(this.displayText.getText());
			
			this.displayText.setText("");
			
			if(operator.equals("+")) { this.displayText.setText(Float.toString(num11+num22));}
		...
		else if	(accti.equals("C")) {
				this.displayText.setText(""); 
			}
		else {		
			this.displayText.setText(this.displayText.getText()+accti);
		}
